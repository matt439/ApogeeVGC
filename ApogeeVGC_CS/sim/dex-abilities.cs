...
namespace ApogeeVGC_CS.sim
{
    ...
    {
        public bool? Breakable { get; init; } // Can be suppressed by Mold Breaker and related effects
        public bool? CantSuppress { get; init; } // Ability can't be suppressed by e.g. Gastro Acid or Neutralizing Gas
        public bool? FailRolePlay { get; init; } // Role Play fails if target has this Ability
        public bool? FailSkillSwap { get; init; } // Skill Swap fails if either the user or target has this Ability
        public bool? NoEntrain { get; init; } // Entrainment fails if user has this Ability
        public bool? NoReceiver { get; init; } // Receiver and Power of Alchemy will not activate if an ally faints with this Ability
        public bool? NoTrace { get; init; } // Trace cannot copy this Ability
        public bool? NoTransform { get; init; } // Disables the Ability if the user is Transformed
    }

    public class AbilityData : Ability, IAbilityEventMethods, IPokemonEventMethods
    {
        ...
        // Fix return types to match interface
        ...
        // Fix remaining properties with corrected return types
        ...
        // Any event handlers - fix return types
        ...
        // Ally event handlers with correct return types
    ...
    public class Ability : BasicEffect, IBasicEffect, IEffect
    {
        ...
        public required bool SuppressWeather { get; init; }
        public required AbilityFlags Flags { get; init; }
        ...
        // Add missing IEffect implementations
        public Action<Battle, Pokemon>? OnAnySwitchIn { get; init; }
        public Action<Battle, Pokemon>? OnSwitchIn { get; init; }
