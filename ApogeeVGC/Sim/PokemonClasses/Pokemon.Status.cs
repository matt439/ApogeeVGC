...
public partial class Pokemon
{
    ...
    {
        // Clear this Pok�mon's current volatiles
        ClearVolatile();
        ...
        foreach ((ConditionId conditionId, EffectState volatileState) in pokemon.Volatiles)
        {
            ...
            // Create a shallow clone of the volatile state with this Pok�mon as the target
            ...
            // Update all linked Pok�mon to point to this Pok�mon instead of the source
            foreach (Pokemon linkedPoke in clonedState.LinkedPokemon)
            {
                // Get the linked Pok�mon's volatile state for this condition
                ...
                // Find and replace the source Pok�mon with this Pok�mon
        ...
        // Clear the source Pok�mon's volatiles after copying
