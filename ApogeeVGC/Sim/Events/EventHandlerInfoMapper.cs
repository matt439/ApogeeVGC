...
public static class EventHandlerInfoMapper
{
    ...
    /// </summary>
    private static readonly FrozenDictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>> EventMethodsMap =
...
[EventId.SideConditionStart] = e => e.OnSideConditionStart,
 ...
 [EventId.Swap] = e => e.OnSwap,
  ...
  /// Maps EventId + EventPrefix.Foe to property accessor functions.
    /// </summary>
    private static readonly FrozenDictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>> FoeEventMethodsMap =
        new Dictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>>
        {
 ...
 [EventId.PrepareHit] = e => e.OnFoePrepareHit,
  ...
  /// Maps EventId + EventPrefix.Source to property accessor functions.
    /// </summary>
    private static readonly FrozenDictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>> SourceEventMethodsMap =
    new Dictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>>
  {
 ...
 [EventId.ModifySpD] = e => e.OnSourceModifySpD,
  ...
  [EventId.TryBoost] = e => e.OnSourceTryBoost,
   ...
   [EventId.TryHitField] = e => e.OnSourceTryHitField,
    ...
    /// </summary>
    private static readonly FrozenDictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>> AnyEventMethodsMap =
  new Dictionary<EventId, Func<IEventMethodsV2, EventHandlerInfo?>>
        {
...
[EventId.ModifySpA] = e => e.OnAnyModifySpA,
 ...
 [EventId.Type] = e => e.OnAnyType,
    ...
    /// </summary>
    private static readonly FrozenDictionary<EventId, Func<IPokemonEventMethodsV2, EventHandlerInfo?>> AllyEventMethodsMap =
 ...
 [EventId.TryBoost] = e => e.OnAllyTryBoost,
  ...
  [EventId.TryHeal] = e => e.OnAllyTryHeal,
   ...
   [EventId.Type] = e => e.OnAllyType,
    ...
    /// </summary>
    private static readonly FrozenDictionary<EventId, Func<IAbilityEventMethodsV2, EventHandlerInfo?>> AbilityEventMethodsMap =
        ...
        EventSuffix? suffix = null)
    {
        ...
        if (prefix.HasValue && effect is IEventMethodsV2 eventMethods)
     {
      ...
      EventPrefix.Source when SourceEventMethodsMap.TryGetValue(id, out var accessor) => accessor(eventMethods),
       EventPrefix.Any when AnyEventMethodsMap.TryGetValue(id, out var accessor) => accessor(eventMethods),
