...
/// <summary>
/// Event handler info for OnAnyTryHitSide event.
/// Signature: Func<Battle, Pokemon, Pokemon, ActiveMove, BoolEmptyVoidUnion?>
/// </summary>
public sealed record OnAnyTryHitSideEventInfo : EventHandlerInfo
{
    [Obsolete("Use Create factory method instead.")]
    public OnAnyTryHitSideEventInfo(
...
Priority = priority;
    ...
    /// </summary>
    public static OnAnyTryHitSideEventInfo Create(
        Func<Battle, Pokemon, Pokemon, ActiveMove, BoolEmptyVoidUnion?> handler,
        int? priority = null,
        bool usesSpeed = true)
    {
        return new OnAnyTryHitSideEventInfo(
                        context =>
            {
                var result = handler(
                    context.Battle,
