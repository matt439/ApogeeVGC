...
/// <summary>
/// Event handler info for OnAllyModifySpD event.
/// Modifies the Special Defense stat when targeting/affecting allies.
...
{
    /// <summary>
    /// Creates a new OnAllyModifySpD event handler.
    /// </summary>
