...
/// <summary>
/// Message for when a Pok�mon uses a move
/// </summary>
...
/// <summary>
/// Message for when a Pok�mon takes damage
/// </summary>
public class DamageMessage : BattleMessage
{
    ...
    public override string ToDisplayText()
    {
        ...
        string baseMessage =
            $"{pokemonDisplay} took {DamageAmount} damage! ({percentRemaining:F1}% HP remaining)";
...
/// <summary>
/// Message for when a Pok�mon faints
/// </summary>
...
/// <summary>
/// Message for when a Pok�mon is switched in
/// </summary>
...
/// <summary>
/// Message for when a Pok�mon can't move (flinch, paralysis, sleep, etc.)
/// </summary>
