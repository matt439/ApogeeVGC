...
{
    /// <summary>
    /// Applies damage to a single Pok�mon.
    /// This is a convenience wrapper around SpreadDamage for single-target damage.
    /// </summary>
    /// <param name="damage">Amount of damage to deal</param>
    /// <param name="target">Target Pok�mon (defaults to event target)</param>
    /// <param name="source">Source Pok�mon causing the damage (defaults to event source)</param>
    ...
    /// <summary>
    /// Applies damage directly to a Pok�mon without triggering the Damage event.
        ...
        BattleHealEffect? effect = null)
    {
        ...
        if (target is null)
        {
            throw new InvalidOperationException("Target Pok�mon is null.");
        }
    ...
    /// <summary>
    /// Modifies a Pok�mon's stat stages (boosts) during battle.
    /// 
    /// Process:
