...
public partial class Driver
{
    ...
    /// Accepts fixture JSON and Showdown log content strings (from SQLite cache).
    ///
    /// Compares protocol output line-by-line with Showdown's output.
    /// </summary>
    public void RunEquivalenceTest(string fixtureJson, string showdownLogContent)
    {
        Console.WriteLine("[Equivalence] Loading fixture and log from SQLite cache");
        ...
        string[] showdownLines = showdownLogContent.Split(['\r', '\n'], StringSplitOptions.RemoveEmptyEntries);
