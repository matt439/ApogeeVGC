...
public record EventIdInfoData
{
 ...
 UsesEffectOrder = true,
  ...
  UsesFractionalSpeed = true,
        ...
        [EventId.BeforeSwitchIn] = new EventIdInfo { Id = EventId.BeforeSwitchIn, UsesSpeed = true },
        [EventId.BeforeSwitchOut] = new EventIdInfo { Id = EventId.BeforeSwitchOut, UsesSpeed = true },
        [EventId.SwitchOut] = new EventIdInfo { Id = EventId.SwitchOut, UsesSpeed = true },
        [EventId.AfterSwitchInSelf] = new EventIdInfo { Id = EventId.AfterSwitchInSelf, UsesSpeed = true },
     ...
     [EventId.SideResidual] = new EventIdInfo
{
 ...
 // Turn-related events
    ...
    [EventId.TrapPokemon] = new EventIdInfo { Id = EventId.TrapPokemon, UsesSpeed = true },
        [EventId.MaybeTrapPokemon] = new EventIdInfo { Id = EventId.MaybeTrapPokemon, UsesSpeed = true },
   ...
   [EventId.DisableMove] = new EventIdInfo { Id = EventId.DisableMove, UsesSpeed = true },
    [EventId.ModifyPriority] = new EventIdInfo { Id = EventId.ModifyPriority, UsesSpeed = true },
...
Id = EventId.AnyInvulnerability,
  ...
  UsesLeftToRightOrder = true,
   ...
   [EventId.AfterMove] = new EventIdInfo { Id = EventId.AfterMove, UsesSpeed = true },
     [EventId.AfterMoveSelf] = new EventIdInfo { Id = EventId.AfterMoveSelf, UsesSpeed = true },
        [EventId.AfterMoveSecondary] = new EventIdInfo { Id = EventId.AfterMoveSecondary, UsesSpeed = true },
        [EventId.AfterMoveSecondarySelf] = new EventIdInfo { Id = EventId.AfterMoveSecondarySelf, UsesSpeed = true },
 ...
 // Damage and healing events
      ...
      [EventId.AfterSubDamage] = new EventIdInfo { Id = EventId.AfterSubDamage, UsesSpeed = true },
  
        // Status and volatile events
        [EventId.SetStatus] = new EventIdInfo { Id = EventId.SetStatus, UsesSpeed = true },
     [EventId.AfterSetStatus] = new EventIdInfo { Id = EventId.AfterSetStatus, UsesSpeed = true },
        [EventId.TryAddVolatile] = new EventIdInfo { Id = EventId.TryAddVolatile, UsesSpeed = true },
  ...
  [EventId.TryBoost] = new EventIdInfo { Id = EventId.TryBoost, UsesSpeed = true },
     ...
     [EventId.AfterEachBoost] = new EventIdInfo { Id = EventId.AfterEachBoost, UsesSpeed = true },
...
UsesSpeed = true,
 ...
 BaseEventId = EventId.BasePower,
  ...
  [EventId.ModifyDamagePhase1] = new EventIdInfo { Id = EventId.ModifyDamagePhase1, UsesSpeed = true },
        [EventId.ModifyDamagePhase2] = new EventIdInfo { Id = EventId.ModifyDamagePhase2, UsesSpeed = true },
        [EventId.ModifyAccuracy] = new EventIdInfo { Id = EventId.ModifyAccuracy, UsesSpeed = true },
  ...
  [EventId.SourceModifyAccuracy] = new EventIdInfo
   ...
   BaseEventId = EventId.ModifyAccuracy,
       UsesSpeed = true,
        ...
        [EventId.ModifyCritRatio] = new EventIdInfo { Id = EventId.ModifyCritRatio, UsesSpeed = true },
 [EventId.CriticalHit] = new EventIdInfo { Id = EventId.CriticalHit, UsesSpeed = true },
     ...
     [EventId.ModifyTarget] = new EventIdInfo { Id = EventId.ModifyTarget, UsesSpeed = true },
        ...
        [EventId.ModifySecondaries] = new EventIdInfo { Id = EventId.ModifySecondaries, UsesSpeed = true },
...
[EventId.NegateImmunity] = new EventIdInfo { Id = EventId.NegateImmunity, UsesSpeed = true },
   ...
   [EventId.WeatherChange] = new EventIdInfo { Id = EventId.WeatherChange, UsesSpeed = true },
      [EventId.WeatherModifyDamage] = new EventIdInfo { Id = EventId.WeatherModifyDamage, UsesSpeed = true },
...
[EventId.SideStart] = new EventIdInfo { Id = EventId.SideStart, UsesSpeed = true },
      ...
      [EventId.SideConditionStart] = new EventIdInfo { Id = EventId.SideConditionStart, UsesSpeed = true },
        [EventId.PseudoWeatherChange] = new EventIdInfo { Id = EventId.PseudoWeatherChange, UsesSpeed = true },
 ...
 UsesSpeed = true,
      ...
      [EventId.ChargeMove] = new EventIdInfo { Id = EventId.ChargeMove, UsesSpeed = true },
        [EventId.PriorityChargeCallback] = new EventIdInfo { Id = EventId.PriorityChargeCallback, UsesSpeed = true },
     ...
     [EventId.Flinch] = new EventIdInfo { Id = EventId.Flinch, UsesSpeed = true },
        [EventId.FractionalPriority] = new EventIdInfo { Id = EventId.FractionalPriority, UsesSpeed = true },
   ...
   [EventId.AfterTerastallization] = new EventIdInfo { Id = EventId.AfterTerastallization, UsesSpeed = true },
      
  // Misc events
        [EventId.OverrideAction] = new EventIdInfo { Id = EventId.OverrideAction, UsesSpeed = true },
      [EventId.BasePowerCallback] = new EventIdInfo { Id = EventId.BasePowerCallback, UsesSpeed = true },
        [EventId.BeforeTurnCallback] = new EventIdInfo { Id = EventId.BeforeTurnCallback, UsesSpeed = true },
        [EventId.BeforeMoveCallback] = new EventIdInfo { Id = EventId.BeforeMoveCallback, UsesSpeed = true },
  [EventId.DamageCallback] = new EventIdInfo { Id = EventId.DamageCallback, UsesSpeed = true },
 ...
 [EventId.Eat] = new EventIdInfo { Id = EventId.Eat, UsesSpeed = true },
    ...
    [EventId.Use] = new EventIdInfo { Id = EventId.Use, UsesSpeed = true },
        [EventId.UseMoveMessage] = new EventIdInfo { Id = EventId.UseMoveMessage, UsesSpeed = true },
    };
}