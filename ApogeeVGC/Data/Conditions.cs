...
public record Conditions
{
    ...
    private readonly Dictionary<ConditionId, Condition> _conditions = new()
    {
        ...
        [ConditionId.QuarkDrive] = new Condition
        {
            ...
            OnStart = (battle, pokemon, _, effect) =>
            {
                if (effect is Item item)
                {
                    if (item.Id == ItemId.BoosterEnergy)
                    {
                        ...
                        //TODO : Print message about Booster Energy activating Quark Drive
                    }
                }
                else
                {
                    //TODO : Print message about Quark Drive activating
                }
                battle.EffectState.BestStat = pokemon.GetBestStat(false, true);
                // TODO : Print message about which stat is boosted
                return null;
            },
            OnModifyAtkPriority = 5,
            ...
            {
                //TODO : Print message about Quark Drive ending
            },
        },
    };
}