    ...
    private partial Dictionary<ItemId, Item> CreateItemsStu()
    {
        return new Dictionary<ItemId, Item>
        {
            ...
            [ItemId.ScopeLens] = new()
            {
                ...
                OnModifyCritRatio =
                    OnModifyCritRatioEventInfo.Create((_, critRatio, _, _, _) =>
            ...
            [ItemId.ShedShell] = new()
            {
                ...
                OnMaybeTrapPokemon =
                    OnMaybeTrapPokemonEventInfo.Create(
                ...
                OnHit = OnHitEventInfo.Create((battle, target, source, move) =>
                {
                        ...
                        battle.CheckMoveMakesContact(move, source, target))
                    {
                        ...
                        if (barb is not ItemItemFalseUnion itemUnion)
                            return null; // Gen 4 Multitype - TS returns undefined
                        source.SetItem(itemUnion.Item.Id);
                        // no message for Sticky Barb changing hands
                    }

                    return null; // TS returns undefined
                }),
                Num = 288,
                Gen = 4,
            },
            ...
            [ItemId.ThroatSpray] = new()
            {
                ...
                OnAfterMoveSecondarySelf =
                    OnAfterMoveSecondarySelfEventInfo.Create((_, pokemon, _, move) =>
                    {
